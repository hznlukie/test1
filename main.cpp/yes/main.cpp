...
void fightmultipleenemies3(int& maxhp, int& hp,
int& maxmana, int& mana,
int& level, int& xp,
int& gold, int& attack,
int monsterattack1, int monsterhp1,
int monsterattack2, int monsterhp2,
int monsterattack3, int monsterhp3)
{
    monsterstun1 = 0;
    monsterstun3 = 0;
    monsterstun2 = 0;
    ...
    cout << "wild pacholiks attack you!     " << endl; this_thread::sleep_for(chrono::milliseconds(1000));
    while (hp > 0 && (monsterhp1 > 0 || monsterhp2 > 0 || monsterhp3 >0)){
    cout << "co je tvuj tah!?" << endl; this_thread::sleep_for(chrono::milliseconds(1000));
    check = 0;
    while (check == 0){
...
if (!(helpmevariable == 1 && vyber == 3)) {
jakynepritel = 0;
while ((jakynepritel != 1 && jakynepritel != 2 && jakynepritel != 3)
    || (jakynepritel == 1 && monsterhp1 <= 0)
    || (jakynepritel == 2 && monsterhp2 <= 0)
    || (jakynepritel == 3 && monsterhp3 <= 0)) //tough condition as hell, i am proud
    {
...
if (monsterhp3 >0){
    cout << endl << "monster 3:                 zije" << endl;
} else {cout << endl << "monster 3:             nezije" << endl;}
...
if (!(cin >> jakynepritel)) {
    ...
    //else if chain 2
    if (vyber==1 && jakynepritel ==1 ){
    cout << "ubral jste prvnimu enemy " << attack << " damage" << endl;
    monsterhp1= monsterhp1 - attack;
    cout << "enemy1 health: " << monsterhp1;
    check = 1;
    }
        else if (vyber==1 && jakynepritel ==2){
        cout << "ubral jste druhymu enemy " << attack << " damage" << endl;
        monsterhp2= monsterhp2 - attack;
        cout << "enemy2 health: " << monsterhp2;
        check = 1;
    }       else if (vyber==1 && jakynepritel ==3){
            cout << "ubral jste tretimu enemy " << attack << " damage" << endl;
            monsterhp2= monsterhp2 - attack;
            cout << "enemy3 health: " << monsterhp2;
            check = 1;
    }
            ...
            mana -= 10;
                ...
                check = 1;
                mana -= 10;
}                   else if (vyber == 2 && helpmevariable == 1 && jakynepritel == 3 && mana >= 10) {
                    cout << "omracil ste tretiho pacholika!";
                    monsterstun3 = 1;
                    check = 1;
                    mana -= 10;
                        else if (vyber == 2 && helpmevariable == 2 && jakynepritel == 1 && mana >= 10) {
                        ...
                        mana -= 10;
                            ...
                            check = 1;
                            mana -= 10;
}                               else if (vyber == 2 && helpmevariable == 2 && jakynepritel == 3 && mana >= 10) {
                                poisondamage3=2;
                                check = 1;
                                mana -= 10;
                                    else if (vyber == 2 && helpmevariable == 3 && jakynepritel == 1 && mana >= 10) {
                                    cout << "ubral si monster 1 " << attack <<" damage";
                                    cout << "ubral si monster 2 " << attack/2 <<" damage";
                                    cout << "ubral si monster 3 " << attack/2 << " damage";
                                    monsterhp1 = monsterhp1 - attack;
                                    monsterhp2 = monsterhp2 - attack/2;
                                    monsterhp3 = monsterhp3 - attack/2;
                                    check = 1;
                                    mana -= 10;
}                                       else if (vyber == 2 && helpmevariable == 3 && jakynepritel == 2 && mana >= 10) {
                                        monsterhp1 = monsterhp1 - attack/2;
